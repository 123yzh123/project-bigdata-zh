...
-- =========================================================================
INSERT OVERWRITE TABLE dws_traffic_page_visitor_page_view_1d PARTITION (dt = '2024-09-12')
SELECT mid_id
     , brand
     , model
     , operate_system
...
*/
INSERT OVERWRITE TABLE gmall.dws_trade_user_sku_order_nd PARTITION (dt = '2024-09-11')
SELECT user_id,
       sku_id,
       sku_name,
       category1_id,
