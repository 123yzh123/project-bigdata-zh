# ======================================================================
#                   todo：1. 订单明细表：order_detail（增量，每日）
# ======================================================================
...
# ======================================================================
#                   todo：2. 订单表：order_info（增量，每一次）
#       create_time 表示数据插入数据、operate_time 表示数据更新数据
# ======================================================================
/opt/module/sqoop/bin/sqoop import \
--connect jdbc:mysql://node101:3306/gmall \
--username root \
...
WHERE date_format(operate_time, '%Y-%m-%d') = '2024-06-19' AND \$CONDITIONS" \
--num-mappers 1 \
--split-by 'id' \
--fields-terminated-by '\t' \
--compress \
